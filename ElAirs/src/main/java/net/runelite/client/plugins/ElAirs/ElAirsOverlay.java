...
@Slf4j
@Singleton
class ElAirsOverlay extends OverlayPanel
{
	private final ElAirsPlugin plugin;
	private final ElAirsConfiguration config;

	String timeFormat;
	private String infoStatus = "Starting...";

	@Inject
	private ElAirsOverlay(final Client client, final ElAirsPlugin plugin, final ElAirsConfiguration config)
	{
		super(plugin);
