...
@Slf4j
@Singleton
class ElAstralsOverlay extends OverlayPanel
{
    private final ElAstralsPlugin plugin;
    private final ElAstralsConfig config;

    String timeFormat;

    @Inject
    private ElAstralsOverlay(final Client client, final ElAstralsPlugin plugin, final ElAstralsConfig config)
    {
        super(plugin);
    ...
    {
        if (plugin.botTimer == null || !plugin.startAstrals || !config.enableUI())
        {
