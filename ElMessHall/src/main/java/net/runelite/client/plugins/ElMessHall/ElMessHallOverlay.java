...
@Slf4j
@Singleton
class ElMessHallOverlay extends OverlayPanel
{
	private final ElMessHallPlugin plugin;
	private final ElMessHallConfiguration config;

	String timeFormat;
	private String infoStatus = "Starting...";

	@Inject
	private ElMessHallOverlay(final ElMessHallPlugin plugin, final ElMessHallConfiguration config)
	{
		super(plugin);
	...
	{
		if (plugin.botTimer == null || !plugin.startMessHall || !config.enableUI())
		{
