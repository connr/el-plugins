...
@Slf4j
@Singleton
class barbarianfisherOverlay extends OverlayPanel
{
	private final barbarianfisherPlugin plugin;
	private final barbarianfisherConfiguration config;

	String timeFormat;
	private String infoStatus = "Starting...";

	@Inject
	private barbarianfisherOverlay(final Client client, final barbarianfisherPlugin plugin, final barbarianfisherConfiguration config)
	{
		super(plugin);
